...
<head>
    ...
    <!-- Styles -->
    <link rel="icon" href="{{ URL::asset('photo/logo2.png') }}" type="image/x-icon"/>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">   
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        <div><img src="{{ asset('photo/Logo1.png') }}" style="height:50px;" alt=""></div>
                        <div class="ml-3 pt-2" style="font-size:1.5rem;">{{ config('app.name', 'Laravel') }}</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Our Tim for this Project</h3>
                        <p>Taufik HIdayat <br> Irfan Hisbullah <br> Yazidul Yasar <br> Aji Soubari <br> Agung Priyo Sembodo </p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        

                    </div>
                    <div class='col-md-4 col-sm-12 pt-3 align-content-end'>
                    <h3>Follow Us On</h3>
                        <ul>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Created for BSI Basecamp Coffe - Pancoran Mas, Depok</p>
                        <p>STT Nurul Fikri - 2021</p>
                    </div>
                    <div class='col-md-6 col-sm-12 payment'> <img src="{{ asset('photo/dompetdigital.png') }}" alt='pembayaranonline'>
                    </div>
