...
<div id="orderan" class="col-12 col-md-12 col-sm-12 col-lg-10">
    <div class="card">
        <div class="card-header">
            ...
            <div class="col-12 col-lg-12 col-md-12 col-sm-12 pt-2">
                <div class="d-flex">
                    <h5 class="pt-2">ORDER DETAILS</h5>
                    <button id="exportpdf" class="btn btn-danger ml-auto">Export PDF</button>
                </div>
                <hr>
                <div class="row">
                    <div class="col-5">
